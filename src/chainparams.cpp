...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "tera001.bitchk.com"));
        vSeeds.push_back(CDNSSeedData("seed2", "tera002.bitchk.com"));
        
        vSeeds.push_back(CDNSSeedData("t1", "node1.teracoex.com"));
        vSeeds.push_back(CDNSSeedData("t2", "node2.teracoex.com"));
        vSeeds.push_back(CDNSSeedData("t3", "node3.teracoex.com"));
        vSeeds.push_back(CDNSSeedData("t4", "node4.teracoex.com"));
