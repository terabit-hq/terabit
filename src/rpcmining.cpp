...
Value getsubsidy(const Array& params, bool fHelp)
{
    ...
    return (uint64_t)GetProofOfWorkReward(NULL,0);
}
...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("blockvalue",    (uint64_t)GetProofOfWorkReward(NULL,0)));
...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Terabit is downloading blocks...[0]");
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Terabit is downloading blocks...[3]");
